...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Biodata Mahasiswa Baru</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">Biodata Mahasiswa Baru</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header text-center">
                            <h3 class="card-title">Identitas Mahasiswa Baru</h3>

                            <div class="card-tools">
                                <a href="<?= base_url('pmb/listditerima'); ?>">Kembali</a>
                            </div>
                        </div>
